...
class Draft extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['dataDok'] = $this->Tulis_m->dataDraft('dokumen', $config['per_page'], $data['start']);
	...
	public function pengajuan()
	{
		...
		$data['total_rows'] = $config['total_rows'];
		$data['start'] = $this->uri->segment(3);
		$data['dataDok'] = $this->Tulis_m->dataPengajuan('dokumen', $config['per_page'], $data['start']);
	...
	public function diTolak()
	{
		...
		$data['total_rows'] = $config['total_rows'];
		$data['start'] = $this->uri->segment(3);
		$data['dataDok'] = $this->Tulis_m->dataDitolak('dokumen', $config['per_page'], $data['start']);
	...
	public function surat()
	{
		...
		$this->load->view('template/header', $data);
		$this->load->view('template/sidebar', $data);
		$this->load->view('Draft/suratKeluar', $data);
		$this->load->view('template/footer', $data);
	}
	public function suratKeluar()
	{
		...
		$this->load->view('template/header', $data);
		$this->load->view('template/sidebar', $data);
		$this->load->view('Draft/previewSurat', $data);
		$this->load->view('template/footer', $data);
	}
}
