...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item <?php if ($title == 'Approval') {
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php if ($judul == 'cekPengajuan') {
                    ...
                    <a href="<?= base_url('Approval/cekPengajuan') ?>" class="menu-link">
        ...
        <li class="menu-item <?php if ($title == 'User') {
        	echo 'active open';
        } ?>">
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php if ($judul == 'Users') {
                	echo 'active';
                } ?>">
                ...
                <li class="menu-item <?php if ($judul == 'Tambah User') {
                	echo 'active';
                } ?>">
                    <a href="<?= base_url('User/tambahUser') ?>" class="menu-link">
        ...
        <li class="menu-item <?php if ($title == 'Draft') {
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item <?php if ($judul == 'Dalam Pengajuan') {
                    ...
                    <a href="<?= base_url('Draft/pengajuan') ?>" class="menu-link">
                ...
                <li class="menu-item <?php if ($judul == 'diTolak') {
                    ...
                    <a href="<?= base_url('Draft/diTolak') ?>" class="menu-link">
