                                 ...
                                 <header>
                                     ...
                                     <div class="header-center">
                                         ...
                                         <div class="address-info">
                                             ...
                                             <p>Telepon</p>
                                             <p>Facsimile</p>
                                             <p>Website: <a href="http://www.bri.co.id">http://www.bri.co.id</a>
                                             </p>
                                         </div>
                                     </div>
                         ...
                         <div class="card-body">
                             <div class="row mb-3">
                                 <div class="col-sm-12 text-center">
                                     <a href="<?= base_url('Draft/KirimData/') . $dd['id_dokumen'].'/'. $dd['checker'].'/'. $dd['signer']?>"
                                         type="button" class="btn btn-primary center">Kirim</a>
                                     <a href="<?= base_url('Draft/edit/') . $dd['id_dokumen']?>" type="button"
